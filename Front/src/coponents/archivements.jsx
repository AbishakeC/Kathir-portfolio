...
const Archivements = ({ topic, detailing, imagename }) => {
  return (
    ...
    <div className="bg-gradient-to-r from-black via-blue-600 to-blue-700 rounded-md shadow-lg overflow-hidden w-full p-4 py-10 hover:shadow-xl hover:scale-110 hover:bg-black duration-200  ">
      <img
        src={imagename}
        alt={topic}
