    ...
    <div className='relative min-h-screen'>
      ...
      className="flex flex-col-reverse lg:flex-row w-full items-center justify-between gap-8 py-10">
          ...
          <div className='w-full lg:w-1/2 text-center lg:text-left'>
            ...
            <div className='lg:flex sm:flex md:flex sm:ml-[30%] sm:scale-75 sm:my-2 bg-blue-600 text-xl gap-3 items-center w-fit  align-middle px-7 -ml-6 scale-75 hover:scale-100 hover:text-blue-800 hover:bg-white rounded-md duration-200  my-2 -mb-14 p-4'>
        ...
        <motion.div className='flex flex-col lg:my-8  sm:-my-4 md:flex-row sm:flex-row  justify-around items-center bg-transparent  bg-opacity-35 shadow-blue-400  shadow-md  p-6 rounded-3xl w-full scale-50 max-w-6xl gap-6  mt-40'  
        > 
