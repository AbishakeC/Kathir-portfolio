  ...
  return (
    <div className='relative min-h-screen'>
      ...
      className="flex flex-col-reverse lg:flex-row w-full items-center justify-between gap-8 py-10">
        ...
        <motion.div className='flex flex-col lg:my-8  sm:-my-4 md:flex-row sm:flex-row  justify-around items-center bg-transparent  bg-opacity-35 shadow-blue-400  shadow-md  p-6 rounded-3xl w-full scale-75 max-w-6xl gap-6  mt-8'  
