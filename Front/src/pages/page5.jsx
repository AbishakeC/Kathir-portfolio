...
const Page5 = () => {
  return (
    <div className='flex flex-col align-middle justify-center items-center scale-90    '>
        <h1 className='text-6xl text-white font-boldy mt-6 -my-16  '>About</h1>
 ...
 <div className='bg-gradient-to-br from-black  via-slate-950  to-blue-950  mx-12 py-10 h-fit sm:w-[100%] md:w-[100%]   flex flex-col align-middle rounded-md rounded-b-3xl scale-90 my-4'>
     ...
     solutions — from predictive analytics to generative AI applications.
       ...
       <div className='flex lg:flex-row justify-between bg-gradient-to-r from-black to-blue-700 px-12 mx-10 md:flex-col sm:flex-col rounded-md hover:from-black hover:to-black hover:text-white ease-in-out py-5 sm:-my-8 sm:scale-y-75 hover:scale-100 scale-90 duration-300 delay-100  '>
